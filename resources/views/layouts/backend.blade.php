...
<head>
    ...
    <link rel="icon" sizes="192x192" type="">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="fw-semibold text-white tracking-wide" href="/">
                        ...
                        <span class="smini-hidden">
                            Financial<span class="opacity-75">App</span>
                        </span>
                    </a>
                    <!-- END Logo -->
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('cuentas') ? ' active' : '' }}" href="/cuentas">
                                <i class="nav-main-link-icon far  fa-folder-open"></i>
                                <span class="nav-main-link-name">Lista de cuentas</span>
                            </a>
                        </li>
            ...
            <div class="content py-0">
                <div class="row fs-sm">
                    ...
                    <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                        <a class="fw-semibold" href="" target="">
                            Dev GP</a> &copy;
